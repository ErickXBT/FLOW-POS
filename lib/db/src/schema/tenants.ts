...
export const tenantsTable = pgTable("tenants", {
  ...
  enableDeliveryNear: boolean("enable_delivery_near").notNull().default(true),
  enableDeliveryFar: boolean("enable_delivery_far").notNull().default(true),
  enableDeliveryFlat: boolean("enable_delivery_flat").notNull().default(false),
  deliveryFeeNear: integer("delivery_fee_near").notNull().default(0),
  deliveryFeeFar: integer("delivery_fee_far").notNull().default(5000),
  deliveryFeeFlat: integer("delivery_fee_flat").notNull().default(10000),
