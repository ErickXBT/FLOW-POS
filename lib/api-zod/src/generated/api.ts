...
export const ListAdminTenantsResponse = zod.object({
  ...
  "qrisPayload": zod.string().nullish(),
...
export const UpdateTenantBody = zod.object({
  ...
  "qrisPayload": zod.string().optional(),
  "bankName": zod.string().optional(),
  "bankAccountName": zod.string().optional(),
  "bankAccountNumber": zod.string().optional(),
  "enableDelivery": zod.boolean().optional(),
  "enableDeliveryNear": zod.boolean().optional(),
  "enableDeliveryFar": zod.boolean().optional(),
  "enableDeliveryFlat": zod.boolean().optional(),
  "deliveryFeeNear": zod.number().optional(),
  "deliveryFeeFar": zod.number().optional(),
  "deliveryFeeFlat": zod.number().optional(),
  "showVariants": zod.boolean().optional(),
  "showToppings": zod.boolean().optional(),
  "enableCustomerLogin": zod.boolean().optional(),
  "enableTax": zod.boolean().optional(),
